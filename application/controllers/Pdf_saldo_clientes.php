...
class Pdf_saldo_clientes extends CI_Controller {
	...
	function __construct(){
	 ...
	 public function index($opc_id,$fec2,$nm = ''){
        ...
        $fec1='2000-01-01';
        $txt = "and (f.fac_numero LIKE '%$nm%' or f.fac_nombre like '%$nm%' or f.fac_identificacion like '%$nm%') and f.fac_fecha_emision between '$fec1' and '$fec2' and exists (select * from erp_pagos_factura p where p.com_id=f.fac_id and pag_estado=1)";
