...
class Rep_desglose_nc extends CI_Controller {
	...
	function __construct(){
		...
		$this->load->model('rep_desglose_nc_model');
	...
	public function index($opc_id){
		...
		if($_POST){
			...
			$cns_notas=$this->rep_desglose_nc_model->lista_notas_buscador($f1,$f2,$emisor,$txt);
		}else{
			$txt='';
			$emisor='6';
			$f1= date('Y-m-d');
			...
			$this->load->view('reportes/rep_desglose_nc',$data);
