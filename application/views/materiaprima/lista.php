		...
		<div class="box box-body">
			...
			<div class="row">
				<div class="col-md-2">
					...
					?>
						<a href="<?php echo base_url();?>materiaprima/nuevo/<?php echo $permisos->opc_id?>" class="btn btn-success btn-flat"><span class="fa fa-plus"></span> Crear Materia Prima</a>
					<?php 
					}
					?>
				</div>	
					...
					<table id="tbl_list" class="table table-bordered table-list table-hover">
						...
						?>
							<tr>
								...
								<td class="hidden-mobile"style="mso-number-format:'@'"><?php echo $producto->mp_n?></td>
								<td class="hidden-mobile imagen"><img id="fotografia"  onclick="ver_img(<?php echo $producto->id?>)" class="fotografia imagen" src="<?php echo base_url().'imagenes/'.$producto->mp_aa ?>" width="50px" height="50px" class="form-control"></td>
								...
								<td align="center">
									<div class="btn-group">
										...
										?>
											<a href="<?php echo base_url();?>materiaprima/editar/<?php echo $producto->id?>/<?php echo $permisos->opc_id?>" class="btn btn-primary"> <span class="fa fa-edit"></span></a>
										<?php 
										}
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" style="text-align:center;"> Materia Prima </h4>
              </div>
...
<script type="text/javascript">
	...
	function ver_img(id){
		...
		$.ajax({
						url: base_url+"materiaprima/ver_img/"+id,
						type: 'JSON',
						dataType: 'JSON',
						success: function (dt) {
...
<script type="text/javascript">
	function cambiar_es(estado,id){
		...
		Swal.fire({
		  title: 'Desea cambiar de estado a la materia prima?',
		  ...
		  if (result.isConfirmed) {
		    ...
		    var  uri=base_url+"materiaprima/cambiar_estado/"+estado+"/"+id+"/"+op;
				      $.ajax({
				              url: uri,
				              type: 'POST',
				              success: function(dt){
