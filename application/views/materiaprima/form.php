...
<section class="content">
          ...
          <div class="box box-primary">
            <form role="form" action="<?php echo $action?>" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <tr>
                              ...
                              <td colspan="2">
                                  <div class="form-group <?php if(form_error('mp_o')!=''){ echo 'has-error';}?> ">
                                    <input type="text" class="form-control" name="mp_o" id="mp_o" value="<?php if(validation_errors()!=''){ echo set_value('mp_o');}else{ echo $producto->mp_o;}?>" maxlength='25'>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url().'materiaprima/'. $opc_id?>" class="btn btn-default">Cancelar</a>
              </div>
    ...
    <script >
      ...
      function uploadAjax() {
            ...
            uri=base_url+'materiaprima/traer_tipos/'+$('#mp_a').val();
            $.ajax({
                    url: uri,
                    type: 'POST',
                    success: function(dt){
            ...
            function load_imagen(){
                $.ajax({
                    url: base_url+"materiaprima/load_imagen/"+$("#pro_propiedad1").val(),
                    type: 'POST',
                    success: function(dt){
                    dat = dt.split("&&");
                    if (dat[0].length != 0) {
