                              ...
                              <table class="table">
                                ...
                                <tr <?php echo $hidden_as?>>
                                  ...
                                  <td>
                                          ...
                                          <input type="text" class="form-control" name="pln_descripcion" id="pln_descripcion" value="<?php if(validation_errors()!=''){ echo set_value('pln_descripcion');}else{ echo $ctasxpag->pln_descripcion;}?>" list="list_cuentas" onchange="traer_cuenta(0)">
                              ...
                              <tbody>
                                    <tr>
                                        ...
                                        <td <?php echo $hidden_as?>>
                                          ...
                                          <input type="text" class="form-control" name="ctp_banco" id="ctp_banco" value="<?php if(validation_errors()!=''){ echo set_value('ctp_banco');}?>" list="list_cuentas" onchange="traer_cuenta(1)">
                                          <input type="hidden" class="form-control" name="ctp_id_banco" id="ctp_id_banco" value="<?php if(validation_errors()!=''){ echo set_value('ctp_id_banco');}else{echo '0';}?>" >
      ...
      function validar_decimal(obj){
        obj.value = (obj.value + '').replace(/[^0-9.]/g, '');
          ...
          function traer_factura() {
            ...
            function traer_cuenta(opc) {
              if(opc==0){
                vl=$('#pln_descripcion').val();
              }else{
                vl=$('#ctp_banco').val();
              }
              $.ajax({
                  beforeSend: function () {
                      if(opc==0){
                        ...
                        if ($('#ctp_banco').val().length == 0) {
                              alert('Ingrese una cuenta');
                              return false;
                        }
                      }
                    },
                  url: base_url+"ctasxpagar/traer_cuenta/"+vl,
                  type: 'JSON',
                  dataType: 'JSON',
                  success: function (dt) {
                    if (dt.length!= 0) {
                      if(opc==0){
                            ...
                            $('#ctp_id_banco').val(dt.pln_id);
                            $('#ctp_banco').val(dt.pln_codigo);
                      }
                    }else{
