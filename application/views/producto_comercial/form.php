                      ...
                      <td class="col-sm-5">
                        ...
                        <table class="table">
                            ...
                            <tr>
                              ...
                              <td colspan="2">
                                  <div class="form-group <?php if(form_error('mp_p')!=''){ echo 'has-error';}?> ">
                                    <input type="text" class="form-control decimal" name="mp_p" id="mp_p" value="<?php if(validation_errors()!=''){ echo set_value('mp_p');}else{ echo $producto->mp_p;}?>">
                                    <?php echo form_error("mp_p","<span class='help-block'>","</span>");?>
                                  </div>
                                </td>
                            </tr>
                            <tr>
