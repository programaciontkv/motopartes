            ...
            <form role="form" action="<?php echo $action?>" method="post" autocomplete="off">
              <div class="box-body">
                ...
                <div class="form-group <?php if(form_error('vnd_local')!=''){ echo 'has-error';}?>">
                  <label>Usuario</label>
                  <select name="vnd_local" id="vnd_local" class="form-control" onchange="verificar()">
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url().'vendedor/';echo $opc_id ?>" class="btn btn-default">Cancelar</a>
              </div>
...
<script>
  ...
  function verificar(params) {
    ...
    $.ajax({
              url: base_url+"vendedor/verifica/"+vnd_local.value,
              type: 'JSON',
              dataType: 'JSON',
              success: function (dt) {
                
                  if (dt==1) {
                    swal("Error!", "EL USUARIO YA TIENE UN VENDEDOR ASIGNADO!", "error");
                  } 
