...
function clona_detalle(table,opc) {
    ...
    if (d == 0) {
        ...
        var fila = "<tr>"+
                            ...
                            "<td>"+
                              "<input type ='text' class='form-control decimal' size='7' style='text-align:right' id='cantidad"+i+"' name='cantidad"+i+"' lang='"+i+"' onchange='validar_inventario_det()'  value='"+cantidad.value +"' onkeyup='validar_decimal(this),validar_cantidad(1,this)'/>"+
                            "</td>"+
                            "<td>"+
                              "<input type ='text' size='7' style='text-align:right' id='pro_precio"+i+"' name='pro_precio"+i+"' onchange='calculo(),validar_cantidad(1,this)' value='"+pro_precio.value+"' lang='"+i+"' class='form-control decimal' onkeyup='validar_decimal(this)' "+r_precio+" />"+
                            "</td>"+
                            "<td>"+
