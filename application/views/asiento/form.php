                                ...
                                $t_haber=0;
                                  ?>
                                    <tr>
                                        ...
                                        <td>
                                          <input type="hidden" id="con_id_debe" name="con_id_debe"  value="0" lang="1" class="form-control" size="30" readonly/>
                                        ...
                                        <td>
                                          <input type="hidden" id="con_id_haber" name="con_id_haber"  value="0" lang="1" class="form-control" size="30" readonly/>
                                ...
                                <tbody id="lista">
                                  ...
                                  $n=0;
                                    foreach($cns_det as $rst_det) {
                                        $n++;
                                        if($rst_det->con_id_debe==''){
                                          $con_id_debe=0;
                                        }else{
                                          $con_id_debe=$rst_det->con_id_debe;
                                        }

                                        if($rst_det->con_id_haber==''){
                                          $con_id_haber=0;
                                        }else{
                                          $con_id_haber=$rst_det->con_id_haber;
                                        }
                                        ?>
                                      <tr>
                                        ...
                                        <td>
                                          <input type="hidden" id="con_id_debe<?php echo $n ?>" name="con_id_debe<?php echo $n ?>"  value="<?php echo $con_id_debe?>" lang="<?php echo $n ?>" class="form-control" size="30" readonly/>
                                        ...
                                        <td>
                                            <input style="text-align:left " type ="text" class="refer form-control"  id="con_concepto_haber<?php echo $n ?>" name="con_concepto_haber<?php echo $n ?>" value="<?php echo $rst_det->con_concepto_haber ?>" lang="<?php echo $n ?>" size="45" list="list_cuentas" onchange='traer_cuenta(this,1,1)'/>
                                        </td>
                                        <td>
                                          <input type="hidden" id="con_id_haber<?php echo $n ?>" name="con_id_haber<?php echo $n ?>"  value="<?php echo $con_id_haber?>" lang="<?php echo $n ?>" class="form-control" size="30" readonly/>
            ...
            function clona_detalle(table,opc) {
                ...
                if (d == 0) {
                    ...
                    var fila = "<tr>"+
                                        ...
                                        "</td>"+
                                        "<td>"+
                                        "<input type='hidden' id='con_id_debe"+i+"' name='con_id_debe"+i+"'  value='"+con_id_debe.value+"' lang='"+i+"' class='form-control' size='30' readonly/>"+
                                        ...
                                        "</td>"+
                                        "<td>"+
                                          "<input type='text' id='con_valor_debe"+i+"' name='con_valor_debe"+i+"' size='10' value='"+con_valor_debe.value+"' lang='"+i+"' class='form-control decimal' style='text-align:right'  onkeyup='validar_decimal(this)' onchange='calculo()'/>"+
                                        "</td>"+
                                        "<td>"+
                                        ...
                                        "</td>"+
                                        "<td>"+
                                        "<input type='hidden' id='con_id_haber"+i+"' name='con_id_haber"+i+"'  value='"+con_id_haber.value+"' lang='"+i+"' class='form-control' size='30' readonly/>"+
                                        ...
                                        "</td>"+
                                        "<td >"+
                                          "<input type='text' id='con_valor_haber"+i+"' name='con_valor_haber"+i+"' size='10' value='"+con_valor_haber.value+"' lang='"+i+"' class='form-control decimal' style='text-align:right' onkeyup='validar_decimal(this)' onchange='calculo()'/>"+
                                        "</td>"+
                                        "<td onclick='elimina_fila_det(this)' align='center' >"+"<span class='btn btn-danger fa fa-trash'>"+"</span>"+"</td>"+
                                    "</tr>";
                    $('#lista').append(fila);
              ...
              $.ajax({
                  ...
                  error : function(xhr, status) {
                      ...
                      if(tipo==0){
                        if(opc==0){
                          $("#con_id_debe").val('0');
                          $("#con_concepto_debe").val('');
                          $("#con_descripcion_debe").val('');
                        }else{
                          $("#con_id_haber").val('0');
                          $("#con_concepto_haber").val('');
                          $("#con_descripcion_haber").val('');
                        }
                      }else{
                        if(opc==0){
                          $("#con_id_debe"+j).val('0');
                          $("#con_concepto_debe"+j).val('');
                          $("#con_descripcion_debe"+j).val('');
                        }else{
                          $("#con_id_haber"+j).val('0');
                          $("#con_concepto_haber"+j).val('');
