...
<br>
                          ...
                          <table class="table table-bordered table-striped" id="tbl_detalle">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td <?php echo $etq ?>>
                                          <img  id="img" name="img"  value="" lang="1" width="50px" height="50px">
                                           <input type="hidden"  id="img_aux" name="img_aux" lang="1"/>
                                        </td>
                                        <td <?php echo $hid_inv?>>
                                  ...
                                  $n=0;
                                    foreach($cns_det as $rst_det) {
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" id="det_unidad<?PHP echo $n ?>" name="det_unidad<?PHP echo $n ?>" 
                                            lang="<?PHP echo $n ?>" class="form-control" value="<?PHP echo $rst_det->det_unidad ?>" readonly></td>
                                            
                                            <td <?php echo $etq ?>>
                                            <img src="<?PHP echo base_url()."imagenes/".$rst_det->foto  ?>" id="img<?PHP echo $n ?>" name="img<?PHP echo $n ?>"  value="" lang="<?PHP echo $n ?>" width="50px" height="50px">
                                            <input type="hidden"  id="img_aux<?PHP echo $n ?>" name="img_aux<?PHP echo $n ?>" lang="1"/>
                                            </td>
    ...
    <script >
      ...
      var etq = '<?php echo $etq ?>';
      var iva = '<?php echo $t_iva ?>';
        ...
        $.ajax({
            ...
            function validar(table, opc){
              ...
              if(opc==0){
                ...
                if($('#det_cantidad').val().length!=0 &&  parseFloat($('#det_cantidad').val())>0  && $('#det_descuento_porcentaje').val().length!=0 && $('#det_cod_producto').val().length!=0){
            ...
            function validar_cantidad(opc,obj){
              if(opc==0){
                  if (obj>0) {
                      n=obj;
                      if($('#det_cantidad'+n).val().length==0 || parseFloat($('#cantidad'+n).val())<=0){
                        swal("Advertencia!", "Revise que la cantidad sea mayor a 0.!", "warning");
                        $('#det_cantidad'+n).css({borderColor: "red"});
                        $('#det_cantidad'+n).focus();
                      }else{
                        $('#det_cantidad'+n).css({borderColor: ""});
                      }

                      if($('#det_vunit'+n).val().length==0 ||  parseFloat($('#det_vunit'+n).val())<=0){
                        swal("Advertencia!", "Revise que el precio sea mayor a 0.!", "warning");
                        $('#det_vunit'+n).css({borderColor: "red"});
                        $('#det_vunit'+n).focus();
                      }else{
                        $('#det_vunit'+n).css({borderColor: ""});
                      }
                  }else{

                      swal("Advertencia!", "Revise que la cantidad o precio sean mayor a 0.!", "warning");
                    if($('#det_cantidad').val().length==0 ||  parseFloat($('#cantidad').val())<=0){
                      $('#det_cantidad').css({borderColor: "red"});
                      $('#det_cantidad').focus();
                    }

                    if($('#det_vunit').val().length==0 ||  parseFloat($('#det_vunit').val())<=0){
                      $('#det_vunit').css({borderColor: "red"});
                      $('#det_vunit').focus();
                    }
          ...
          "<td "+etq+"> <img src="+base_url+"imagenes/"+img_aux.value+" id='img"+i+"' name='img"+i+"'  lang='"+i+"' width='50px' height='50px'> </td>"+
                    ...
                    success: function (dt) {
                      if (dt!='') {
                        ...
                        if(dt.img==''){
                           ...
                           $('#img').prop('src', base_url+'imagenes/'+dt.img);
                           $('#img_aux').val(dt.img);
                        }
                        if (inven == 0) {
                            if (dt.inventario == '') {
            ...
            function calculo(obj) {
                ...
                while (n < i) {
                    ...
                    if(ob!='0'&& ob!='EX' && ob!='NO'){
                      ...
                      tiva = ((round(tice, dec) + round(t12, dec)) * iva / 100);
                    }
