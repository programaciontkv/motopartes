                            ...
                            <form>
                              ...
                              <table class="table table-bordered table-striped">
                                ...
                                <tr <?php echo $hidden ?>>
                                  ...
                                  <td>
                                    ...
                                    // }else{
                                      ...
                                      $pln_id=$cheque->pln_id;
                                    // }
                                    ?>
                                    <input type="hidden" readonly name="chq_pln_id" id="chq_pln_id" class="form-control"
                                    value="<?php echo $pln_id  ?>">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <input type="hidden" readonly name="id_cta_abono" id="id_cta_abono" class="form-control" value="0">
