					...
					<table id="tbl_list" class="table table-bordered table-list table-hover table-striped" width="100%">
						...
						?>
							<tr>
								...
								<td class="hidden-mobile" hidden style="mso-number-format:'@'"><?php echo $egreso->mov_guia_transporte?></td>
								<td><?php echo $egreso->cli_raz_social?></td>
								<td class="hidden-mobile" hidden style="mso-number-format:'@'"><?php echo $egreso->mp_c?></td>
